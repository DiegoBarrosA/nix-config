...
let
  ...
  tofi-bluemenu = pkgs.writeTextFile {
    name = "tofi-bluemenu";
    destination = "/bin/tofi-bluemenu";
    executable = true;
    text = ''
      #!/usr/bin/env bash
      #             __ _       _     _            _              _   _
      ...
      show_menu() {
          ...
          # Open rofi menu, read chosen option
          chosen="$(echo -e "$options" | $rofi_command " Devices:")"
...
in {
  home.packages = with pkgs; [ tofi tofi-powermenu tofi-bluemenu ];
