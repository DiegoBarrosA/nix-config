...
# Generated by: XDG_CONFIG_HOME=/tmp/gsd-capture npx @opengsd/gsd-core@latest --opencode --global
    ...
    builtins.filter (x: x != null) (
      builtins.attrValues (builtins.mapAttrs (name: type:
        if type == "regular" then
          { inherit name; value = builtins.readFile ./gsd-core-refs/${name}; }
        else null
      ) (builtins.readDir ./gsd-core-refs))
    )
  );
}
