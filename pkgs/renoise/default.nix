{ lib, stdenv, alsa-lib, fetchurl, libjack2, libX11, libXcursor, libXext
, libXinerama, libXrandr, libXtst, mpg123, pipewire, releasePath ? null }:
...
in stdenv.mkDerivation rec {
  ...
  src = if releasePath != null then
    ...
    let
      platform = platforms.${stdenv.system} or (throw
